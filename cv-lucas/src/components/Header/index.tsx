  ...
  return (
    <header className={styles.header}>
      <div className={styles.headerContainer}>
        ...
        <div className={styles.headerButtons}>
          {isProjects ? (
            <>
              ...
              <button
                onClick={() => router.push("/projects/projeto1")}
                className={styles.buttons}
              >
                Projeto 1
              </button>
              <button
                onClick={() => router.push("/projects/projeto2")}
                className={styles.buttons}
              >
                Projeto 2
              </button>
        ...
        <div
          className={`${menuOpen ? styles.visible : ""} ${
            styles.sideHeaderButtons
          }`}
        >
          {isProjects ? (
            <>
